...
forensic-scanner-interface-photograph = Photograph analysis
forensic-scanner-interface-photo-origin = Image origin: { $origin }
forensic-scanner-interface-photo-size = Image dimensions: { $width }×{ $height }
forensic-scanner-interface-photo-print = Physical print: { $print }
forensic-scanner-photo-origin-camera = camera capture
forensic-scanner-photo-origin-uploaded = digital file
forensic-scanner-photo-original = original
forensic-scanner-photo-copy = copy
